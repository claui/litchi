...
## Setting up Litchi for development

To set up Litchi, you need three things:
...
the exact Python version required by Litchi,
...
### Checking Litchi’s dependencies for vulnerabilities

To check Litchi’s dependencies for known vulnerabilities, run:

```
poetry run poe check
```

### Checking Litchi’s dependencies for compatible updates

To check Litchi’s dependencies for compatible updates, run:
